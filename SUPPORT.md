...
Tashtit is community-maintained and currently pre-release.

- Use GitHub Discussions for usage questions and design conversations when
  enabled.
...
The project does not provide an SLA. Stable plugins document their supported
platforms and maintenance status.
