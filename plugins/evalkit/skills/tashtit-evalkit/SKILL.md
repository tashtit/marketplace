...
| --- | --- | --- | --- |
| Review how well **one** skill is authored | `tashtit-review-skill` | Static, read-only | Cheap |
| Compare how well **two** skills are authored | `tashtit-compare-skills` | Static, read-only | Cheap |
| Measure whether a skill **changes task outcomes** (with vs without) | `tashtit-evaluate-skill` | Dynamic, worktrees | Expensive |
| Compare **two skills** head-to-head on the same task | `tashtit-benchmark-skills` | Dynamic, worktrees | Expensive |
| Compare **two models** on the same task | `tashtit-compare-models` | Dynamic, worktrees | Expensive |
| List or remove leftover evaluation worktrees | `tashtit-remove-worktrees` | Utility | Cheap |

## Static vs dynamic

- **Static** skills (`tashtit-review-skill`, `tashtit-compare-skills`) read a skill's files and
...
- **Dynamic** skills (`tashtit-evaluate-skill`, `tashtit-benchmark-skills`, `tashtit-compare-models`) run a
...
1. If the request names authoring quality and one or two skills, route to
   `tashtit-review-skill` / `tashtit-compare-skills`.
...
3. If the request is about cleaning up worktrees, route to `tashtit-remove-worktrees`,
