...
- `tashtit-evaluate-dockerfile` — Node.js Dockerfile hygiene.
- `tashtit-evaluate-npm` — package.json, lockfile, `.npmrc`, and `.nvmrc` hygiene.
- `tashtit-evaluate-repository-hygiene` — CODEOWNERS, README, CONTRIBUTING, and
  `.editorconfig` collaboration hygiene.
- `tashtit-evaluate-ci-workflow` — GitHub Actions CI-workflow security and
...
evidence, priorities, and weights.
